...
Gleiches gilt für das Skript `1_clean_corpus.R`. Dieses Skript soll beispielhaft den Prozess des Korpus-Cleanings zeigen. Beide Skripte greifen auf Funktionen zu, die die Analyse weitestgehend vereinfachen. Bei Fragen zur Funktionsweise der Funktionen schauen Sie gerne ins `0_functions.R`-Skript bzw. in den `functions`-Ordner oder fragen Sie uns. <br><br>
