...
get_tw_and_titles = function(corpus, lda_result, lda_ids, topic = 1, n = 20){
  
  # get titles
  titles = topTexts(lda_result, lda_ids, limit=n)
...
#' Funktion erlaubt den Einsatz verschiedener Speicher-Funktionen. Eroeglicht damit den flexiblen Einsatz von
